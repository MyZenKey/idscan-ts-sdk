...
var host = "https://idscan-qa.xcijv.com/";
// @ts-ignore
/**
 * @export
 ...
 */
var PayloadService = {
    getSessionId: function (correlation_id, client_id) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].get(url + "?session_id=" + sessionId + "&ppk=" + publicKeyProvided)
                                .then(function (data) {
...
module.exports.default = PayloadService;